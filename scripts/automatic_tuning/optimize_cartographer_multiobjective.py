...
class CartographerTuning(AutomaticTuning):
    ...
    def setup(self, trial):
        ...
        optimize_every_n_nodes= trial.suggest_int('optimize_every_n_nodes', 200, 600)
        ...
        self.options_dict["map_builder"]["pose_graph"]['optimize_every_n_nodes'] = optimize_every_n_nodes
    ...
    def run(self, trial):
        ...
        #print(rpe["rmse"])
            ...
            rmse_list.append(data['trans']['rmse'])

        print(rmse_list)
        return rmse_list[0], rmse_list[1] 
...
def main():
    tuning = CartographerTuning('cartographer_tuning_multi_seq')
    ...
    importances_dict=optuna.importance.get_param_importances(study=tuning.study, normalize=True, params=['translation_weight','rotation_weight','num_range_data','voxel_filter_size','optimize_every_n_nodes'])
